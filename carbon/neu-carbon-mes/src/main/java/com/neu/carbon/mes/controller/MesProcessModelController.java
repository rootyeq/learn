...
public class MesProcessModelController extends BaseController
{
    ...
    public TableDataInfo list(MesProcessModel mesProcessModel)
    {
        ...
        list.stream().forEach(item -> {
            WmsMaterialInfo wmsMaterialInfo = materialInfoService.selectWmsMaterialInfoById(item.getMaterialId());
            if(wmsMaterialInfo != null){
                item.setMaterialName(wmsMaterialInfo.getName());
            }
    ...
    {
        return AjaxResult.success(mesProcessModelService.selectMesProcessModelById(id));
    }
