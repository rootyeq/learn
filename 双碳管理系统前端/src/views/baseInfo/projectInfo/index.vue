<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="projectInfoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="项目介绍" align="center" prop="description" >
        <template slot-scope="scope">
          <img v-if="scope.row.description" :src="'http://localhost:9090' + scope.row.description" width="100%" height="100%" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="项目介绍">
          <imageUpload v-model="form.description"/>
        </el-form-item>
        <el-form-item label="项目状态" prop="status">
